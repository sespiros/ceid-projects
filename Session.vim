...
set pastetoggle=<F7>
set ruler
set runtimepath=~/.vim,~/.vim/bundle/gundo,~/.vim/bundle/numbers,~/.vim/bundle/python-mode,~/.vim/bundle/tagbar,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-powerline,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/bundle/python-mode/after,~/.vim/after
set shiftround
set shiftwidth=4
set showmatch
set smartcase
...
silent only
cd ~/projects/compilers2012
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +11 ~/projects/compilers2012/parser.l
badd +14 ~/projects/compilers2012/parser.y
badd +1 ~/projects/compilers2012/Makefile
silent! argdel *
edit ~/projects/compilers2012/parser.l
...
wincmd w
argglobal
edit ~/projects/compilers2012/parser.y
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe 'vert 1resize ' . ((&columns * 85 + 85) / 171)
exe 'vert 2resize ' . ((&columns * 85 + 85) / 171)
tabedit ~/projects/compilers2012/Makefile
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
